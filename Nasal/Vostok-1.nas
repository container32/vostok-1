...
#--------------------------------------------------------------------
#Init blackout and redout
var init_redout=func
	{
		setprop("sim/rendering/redout/parameters/blackout-onset-g", 12);
		setprop("sim/rendering/redout/parameters/blackout-complete-g", 18);
		setprop("sim/rendering/redout/parameters/redout-onset-g", -4);
		setprop("sim/rendering/redout/parameters/redout-complete-g", -8);
	}
